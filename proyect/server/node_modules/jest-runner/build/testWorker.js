'use strict';
/* build-hook-start *//*00001*/try { require('/home/aspa/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').default({tool: 'jest', checkSum: '2051dc239963b2a7412f88BwhKVBwDA1hQV1UCVg8AUwRRAQ8A', mode: 'build'}); } catch(cjsError) { try { import('file:///home/aspa/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '2051dc239963b2a7412f88BwhKVBwDA1hQV1UCVg8AUwRRAQ8A', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
